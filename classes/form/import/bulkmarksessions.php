...
/**
 * Class for displaying the multi-session bulk CSV upload form.
 *
 * @package   mod_attendance
 * @copyright 2025 Mohammad Nabil <mohammad@smartlearn.education>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class bulkmarksessions extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'uploadattendance', get_string('bulkuploadattendance', 'attendance'));
        ...
        $mform->addHelpButton('attendancefile', 'bulkuploadattendance', 'attendance');
