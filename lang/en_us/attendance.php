...
/**
 * Strings for component 'attendance', language 'en-us'
 *
...
$string['strftimedmyhm'] = '%m/%d/%Y %l:%M%P'; // Line added to allow multiple sessions in the same day.
$string['strftimedmyw'] = '%m/%d/%Y&nbsp;(%a)';
$string['strftimehm'] = '%l:%M%P'; // Line added to allow display of time.
