...
$string['attemptedfraud'] = 'Cannot change the attendance of students who are already marked as Present, Late or Excused.';
...
$string['attendancefile_help'] = 'The attendance file must be a CSV file with UTF-8 encoding that has been generated from a barcode scanner. The file must contain fields for student ID numbers, scan date and scan time.';
...
$string['encodingcolempty'] = 'The encoding column is missing. <br>';
...
$string['idnumcolempty'] = 'The id number column is missing. <br>';
...
$string['invalidcontentformat'] = 'The contents of the uploaded csv file are not organised in the format:
<br>ID Number, Symbology, Scan Time (h:m:s AM/PM), Scan Date (m/d/y), Current Time (h:m:s AM/PM), Current Date (m/d/y), Serial Number
<br>Please ensure that it is saved in the correct format as a comma separated value file (.csv) and try again.';
$string['invaliddateortime'] = 'The scan dates and/or scan times of the uploaded file are not compatible with session date and/or start time.';
...
$string['missing'] = '<br>The uploaded file may be incorrect. Please upload a correctly formatted file or update attendance records manually.';
...
$string['multipledays'] = 'This file contains multiple days of records. Please ensure the uploaded file ONLY contains records that match the session date before re-uploading.  <br><br>';
...
$string['scandatecolempty'] = 'The scan date column is missing. <br>';
...
$string['uploadattendance'] = 'Upload Attendance File';
