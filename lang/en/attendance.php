...
$string['defaultperclowgrade_desc'] = 'Default percentage for the report lowgrade. Only users with grades below this threshold will be shown.';
$string['perclowgrade'] = 'Threshold percentage for lowgrade report';
