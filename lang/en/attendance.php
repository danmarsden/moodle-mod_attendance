...
$string['attendance_course'] = 'Attendet sessions';
...
$string['evaluation_subtitle'] = 'These sessions need to be evaluated:';
$string['evaluate_session'] = 'Evaluate session';
$string['evaluation_help'] = 'Please mark the check box for each student who attended the session and choose the duration of their attendance.';
...
$string['signedupfor_days'] = 'Signed up for {$a} days';
$string['signedupfor_weeks'] = 'Signed up for {$a} weeks';
$string['signedupfor_months'] = 'Signed up for {$a} months';
$string['signedupfor_years'] = 'Signed up for {$a} years';
...
$string['statusunbooked'] = 'unbooked';
$string['statusremark'] = 'Status remark';
$string['statusremark_placeholder'] = 'Enter a note visible to all teachers.';
...
$string['sws_level_0'] = 'SWS_Level_0';
$string['sws_level_1'] = 'SWS_Level_1';
$string['sws_level_2'] = 'SWS_Level_2';
$string['sws_level_3'] = 'SWS_Level_3';
$string['sws_level_4'] = 'SWS_Level_4';
$string['sws_level_5'] = 'SWS_Level_5';
$string['sws_level_6'] = 'SWS_Level_6';
$string['sws_level_7'] = 'SWS_Level_7';
...
$string['templatesenable'] = 'Use mustache templates';
$string['templatesenable_desc'] = 'Use mustache templates instead of legacy html rendering. This makes customizations to the layout easier. Templates are in mod/attendance/templates/.';
