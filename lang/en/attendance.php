...
$string['absenteereportpercentplanned'] = '{$a->percent}% (absent {$a->absent} / {$a->planned} h)';
...
$string['thirdpartyemailtext'] = '{$a->firstname} {$a->lastname} attendance within {$a->coursename} {$a->aname} is below the {$a->warningpercent}% threshold (attendance {$a->attendancepercent}%, absence {$a->absencepercent}%).';
