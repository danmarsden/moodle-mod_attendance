...
$string['donotuserfid'] = 'Do not use rfid';
...
$string['rfidfield'] = 'RFID field';
$string['rfidfield_desc'] = 'User profile field that contains the user RFID tag. The information of this field will be used by attendance web services.';
