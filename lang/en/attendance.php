...
$string['addroom_success'] = 'New room was added.';
...
$string['deleteroomconfirm'] = 'Are you sure you want to delete room "{$a}"?';
...
$string['editroom_success'] = 'Edited room "{$a}" successfully.';
...
$string['error:deleteroomerror'] = 'An error occured while deleting the room';
...
$string['mustbenumericorempty'] = 'Must be a number or empty';
...
$string['roomdeleted'] = 'Room was deleted successfully';
