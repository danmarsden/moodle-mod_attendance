...
$string['bulkimportsuccess'] = 'Successfully processed attendance: marked {$a->records} records across {$a->sessions} sessions.';
$string['bulkmarksessionimportcsvhelp'] = 'This form allows you to upload a CSV file to mark attendance across multiple sessions. The file must include columns for the session (Session Date or Session ID), a user identifier (email, username, or ID number), and a status (e.g. P, L, E, A) or scan time.';
$string['bulkuploadattendance'] = 'Bulk upload attendance';
$string['bulkuploadattendance_help'] = 'Upload a CSV file containing attendance for multiple sessions. Supported columns include session identifier (date or session ID), student identifier (email, username, or ID number), and status (P, L, E, A) or scan time.';
...
$string['error:sessionnotfound'] = 'Session \'{$a}\' could not be found for this attendance activity';
$string['error:sessionuserduplicate'] = 'User {$a->extuser} was found more than once for session {$a->session} in the import file.';
...
$string['sessionimportfield'] = 'Session import field';
$string['sessionimportfield_help'] = 'Select the column from the CSV file that contains the session identifier.';
$string['sessionimportto'] = 'Identify session by';
$string['sessionimportto_help'] = 'Select how sessions are identified in the CSV: by Session Date (e.g. YYYY-MM-DD or readable date) or by Session ID.';
