...
final class remove_session_test extends base_external_testcase {
    /**
     * Tests removing an existing session as a teacher.
     *
    ...
    /**
     * Tests that an unknown session id triggers a missing-record exception.
     *
     * @covers \mod_attendance\external\remove_session::execute
     */
    ...
    /**
     * Tests that students cannot remove sessions.
     *
     * @covers \mod_attendance\external\remove_session::execute
     */
