...
Feature: Test the various new features in the attendance module
  ...
  Scenario: A teacher can create and use multiple status lists
    ...
    And I set the field with xpath "//*[@id='lastrow']/td[2]/input" to "G"
    And I set the field with xpath "//*[@id='lastrow']/td[3]/input" to "Great"
    And I set the field with xpath "//*[@id='lastrow']/td[4]/input" to "3"
    And I click on "Add" "button" in the ".lastrow" "css_element"
    And I set the field with xpath "//*[@id='lastrow']/td[2]/input" to "O"
    And I set the field with xpath "//*[@id='lastrow']/td[3]/input" to "OK"
    And I set the field with xpath "//*[@id='lastrow']/td[4]/input" to "2"
    And I click on "Add" "button" in the ".lastrow" "css_element"
    And I set the field with xpath "//*[@id='lastrow']/td[2]/input" to "B"
    And I set the field with xpath "//*[@id='lastrow']/td[3]/input" to "Bad"
    And I set the field with xpath "//*[@id='lastrow']/td[4]/input" to "0"
    And I click on "Add" "button" in the ".lastrow" "css_element"
