...
Feature: Test the calendar related features in the attendance module
  ...
  Background:
    ...
    And I add a "Attendance" to section "1" and I fill the form with:
      | Name                   | Test attendance 1 |
      | Create calendar events | Yes               |
    And I add a "Attendance" to section "1" and I fill the form with:
      | Name                   | Test attendance 2 |
  ...
  Scenario: Calendar events can be created automatically with sessions creation
    ...
    And I follow "Course 1"
    And I follow "Test attendance 1"
    ...
    Then I should see "Test attendance 1"
    And I log out
    And I log in as "student1"
    And I follow "Go to calendar"
    Then I should see "Test attendance 1"

  Scenario: Teacher can create calendar events for sessions
    When I log in as "teacher1"
    And I follow "Course 1"
    And I follow "Test attendance 2"
    And I follow "Add session"
    And I set the following fields to these values:
      | id_sestime_starthour | 01 |
      | id_sestime_endhour   | 02 |
    ...
    And I follow "Course 1"
    And I follow "Go to calendar"
    Then I should see "Test attendance 2"
    And I log out
    And I log in as "student1"
    And I follow "Go to calendar"
    Then I should see "Test attendance 2"

  Scenario: Teacher can delete calendar events for sessions
    When I log in as "teacher1"
    And I follow "Course 1"
    And I follow "Test attendance 1"
    And I follow "Add session"
    ...
    And I follow "Course 1"
    And I follow "Go to calendar"
    Then I should not see "Test attendance 1"
    And I log out
    And I log in as "student1"
    And I follow "Go to calendar"
    Then I should not see "Test attendance 1"
