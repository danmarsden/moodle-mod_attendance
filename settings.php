...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect(
        'attendance/resultsperpage',
        get_string('resultsperpage', 'attendance'),
        get_string('resultsperpage_desc', 'attendance'),
        25,
        $options
    ));

    $settings->add(new admin_setting_configcheckbox(
        'attendance/studentscanmark',
        get_string('studentscanmark', 'attendance'),
        get_string('studentscanmark_desc', 'attendance'),
        1
    ));

    $settings->add(new admin_setting_configcheckbox(
        'attendance/allowupdatestatus',
        get_string('allowupdatestatus', 'attendance'),
        get_string('allowupdatestatus_desc', 'attendance'),
        0
    ));

    $settings->add(new admin_setting_configtext(
        'attendance/rotateqrcodeinterval',
        get_string('rotateqrcodeinterval', 'attendance'),
        get_string('rotateqrcodeinterval_desc', 'attendance'),
        '15',
        PARAM_INT
    ));

    $settings->add(new admin_setting_configtext(
        'attendance/rotateqrcodeexpirymargin',
        get_string('rotateqrcodeexpirymargin', 'attendance'),
        get_string('rotateqrcodeexpirymargin_desc', 'attendance'),
        '2',
        PARAM_INT
    ));

    $settings->add(new admin_setting_configcheckbox(
        'attendance/studentscanmarksessiontime',
        get_string('studentscanmarksessiontime', 'attendance'),
        get_string('studentscanmarksessiontime_desc', 'attendance'),
        1
    ));

    $settings->add(new admin_setting_configtext(
        'attendance/studentscanmarksessiontimeend',
        get_string('studentscanmarksessiontimeend', 'attendance'),
        get_string('studentscanmarksessiontimeend_desc', 'attendance'),
        '60',
        PARAM_INT
    ));

    $settings->add(new admin_setting_configcheckbox(
        'attendance/subnetactivitylevel',
        get_string('subnetactivitylevel', 'attendance'),
        get_string('subnetactivitylevel_desc', 'attendance'),
        1
    ));
    ...
    $settings->add(new admin_setting_configselect(
        ...
        get_string('defaultview_desc', 'attendance'),
        ATT_VIEW_WEEKS,
        $options
    ));

    $settings->add(new admin_setting_configcheckbox(
        'attendance/multisessionexpanded',
        get_string('multisessionexpanded', 'attendance'),
        get_string('multisessionexpanded_desc', 'attendance'),
        0
    ));

    $settings->add(new admin_setting_configcheckbox(
        'attendance/showsessiondescriptiononreport',
        get_string('showsessiondescriptiononreport', 'attendance'),
        get_string('showsessiondescriptiononreport_desc', 'attendance'),
        0
    ));

    $settings->add(new admin_setting_configcheckbox(
        'attendance/studentrecordingexpanded',
        get_string('studentrecordingexpanded', 'attendance'),
        get_string('studentrecordingexpanded_desc', 'attendance'),
        1
    ));

    $settings->add(new admin_setting_configcheckbox(
        'attendance/enablecalendar',
        get_string('enablecalendar', 'attendance'),
        get_string('enablecalendar_desc', 'attendance'),
        1
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'attendance/automark_useempty',
        get_string('automarkuseempty', 'attendance'),
        get_string('automarkuseempty_desc', 'attendance'),
        1
    ));
    ...
    $settings->add(new admin_setting_configduration(
        'attendance/mobilesessionfrom',
        get_string('mobilesessionfrom', 'attendance'),
        get_string('mobilesessionfrom_help', 'attendance'),
        6 * HOURSECS,
        PARAM_RAW
    ));

    $settings->add(new admin_setting_configduration(
        'attendance/mobilesessionto',
        get_string('mobilesessionto', 'attendance'),
        get_string('mobilesessionto_help', 'attendance'),
        24 * HOURSECS,
        PARAM_RAW
    ));
    ...
    $settings->add(new admin_setting_configtext(
        ...
        get_string('requiresubnet_help', 'attendance'),
        '',
        PARAM_RAW
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'attendance/calendarevent_default',
    ...
    $settings->add(new admin_setting_configcheckbox(
        'attendance/absenteereport_default',
    ...
    $settings->add(new admin_setting_configcheckbox(
        'attendance/studentscanmark_default',
        get_string('studentscanmark', 'attendance'),
        '',
        0
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'attendance/allowupdatestatus_default',
        get_string('allowupdatestatus', 'attendance'),
        '',
        0
    ));
    ...
    $settings->add(new admin_setting_configduration(
        'attendance/studentsearlyopentime',
        get_string('studentsearlyopentime', 'attendance'),
        get_string('studentsearlyopentime_help', 'attendance'),
        0
    ));

    $settings->add(new admin_setting_configcheckbox(
        'attendance/randompassword_default',
    ...
    $settings->add(new admin_setting_configcheckbox(
        'attendance/includeqrcode_default',
    ...
    $settings->add(new admin_setting_configcheckbox(
        'attendance/rotateqrcode_default',
    ...
    $settings->add(new admin_setting_configselect(
        'attendance/preventsharedip',
        get_string('preventsharedip', 'attendance'),
        '',
        ATTENDANCE_SHAREDIP_DISABLED,
        $options
    ));

    $settings->add(new admin_setting_configtext(
        'attendance/preventsharediptime',
        get_string('preventsharediptime', 'attendance'),
        get_string('preventsharediptime_help', 'attendance'),
        '',
        PARAM_RAW
    ));
    ...
    $settings->add(new admin_setting_configselect(
        'attendance/warningpercent',
        get_string('warningpercent', 'attendance'),
        get_string('warningpercent_help', 'attendance'),
        70,
        $options
    ));
    ...
    $settings->add(new admin_setting_configselect(
        'attendance/warnafter',
        get_string('warnafter', 'attendance'),
        get_string('warnafter_help', 'attendance'),
        5,
        $options
    ));
    ...
    $settings->add(new admin_setting_configselect(
        'attendance/maxwarn',
        get_string('maxwarn', 'attendance'),
        get_string('maxwarn_help', 'attendance'),
        1,
        $options
    ));

    $settings->add(new admin_setting_configcheckbox(
        'attendance/emailuser',
        get_string('emailuser', 'attendance'),
        get_string('emailuser_help', 'attendance'),
        1
    ));

    $settings->add(new admin_setting_configtext(
        'attendance/emailsubject',
        get_string('emailsubject', 'attendance'),
        get_string('emailsubject_help', 'attendance'),
        get_string('emailsubject_default', 'attendance'),
        PARAM_RAW
    ));


    $settings->add(new admin_setting_configtextarea(
        'attendance/emailcontent',
        get_string('emailcontent', 'attendance'),
        get_string('emailcontent_help', 'attendance'),
