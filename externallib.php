...
class mod_wsattendance_external extends external_api {
    ...
    public static function get_courses_with_today_sessions_returns() {
		$today_sessions = array('id' => new external_value(PARAM_INT, 'Session id.'),
        ...
        $attendance_instances = array('name' => new external_value(PARAM_TEXT, 'Attendance name.'),
                                      'today_sessions' => new external_multiple_structure(new external_single_structure($today_sessions)));
        ...
        $courses = array('shortname' => new external_value(PARAM_TEXT, 'short name of a moodle course.'),
                         ...
                         'attendance_instances' => new external_multiple_structure(new external_single_structure($attendance_instances)));
	...
	$attendance_log    = array('studentid' => new external_value(PARAM_INT, 'Student id.'),
	...
	$session = array('id' => new external_value(PARAM_INT, 'Session id.'),
					 ...
					 'studentscanmark' => new external_value(PARAM_INT, 'Students can mark their own presence.'),
					 'statusset' => new external_value(PARAM_INT, 'Session statusset.'),
					 'courseid' => new external_value(PARAM_INT, 'Course moodle id.'),
					 'statuses' => new external_multiple_structure(new external_single_structure($statuses)),
					 'attendance_log' => new external_multiple_structure(new external_single_structure($attendance_log)),
				     'users' => new external_multiple_structure(new external_single_structure($users)));
