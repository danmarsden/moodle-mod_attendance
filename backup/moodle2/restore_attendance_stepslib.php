...
class restore_attendance_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $paths[] = new restore_path_element('attendance_notification',
            '/activity/attendance/notifications/notification');
    ...
    /**
     * Process attendance notification restore
     * @param object $data The data in object form
     * @return void
     */
    protected function process_attendance_notification($data) {
        global $DB;
